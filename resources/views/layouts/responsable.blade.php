            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                                 <li class="nav-item">
                                    <a class="nav-link @if(\Route::current()->getName() == 'responsable-accueil') active  @endif" href="{{route('responsable-accueil')}} "><i class="fas fa-house-user"></i>Accueil</a>
                                </li>
                                 <!-- <li class="nav-item">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link @if(\Route::current()->getName() == 'etudiant-encadres') active  @endif" href=" {{route('etudiant-encadres')}}"><i class="fas fa-users"></i> Mes etudiants</a>
                                </li>                           
                                <!-- FIN -->
